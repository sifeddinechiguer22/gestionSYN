        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <header class="h-20 bg-white border-b border-slate-100 px-6 flex items-center justify-between sticky top-0 z-30 shadow-xs">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="relative">
                        <a href="{{ route('resident.notifications') }}" class="p-2 text-slate-500 hover:text-slate-800 hover:bg-slate-100 rounded-xl relative transition" aria-label="Voir les notifications">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
